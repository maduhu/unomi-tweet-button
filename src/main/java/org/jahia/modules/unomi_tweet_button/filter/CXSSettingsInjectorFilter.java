...
public class CXSSettingsInjectorFilter extends AbstractFilter {
    ...
    public String execute(String previousOut, RenderContext renderContext, Resource resource, RenderChain chain) throws Exception {
        final ContextServerSettings contextServerSettings = contextServerSettingsService.getSettings(renderContext.getSite().getSiteKey());
        if (contextServerSettings != null) {
            StringBuilder stringBuilder = new StringBuilder(256);
            stringBuilder.append("<script type=\"text/javascript\">var CXSAuthorizationHeader =");
            ...
            stringBuilder.append("'Basic ").append(Base64.encodeBase64String(usernameBytes)).append("';</script>");
            previousOut += stringBuilder.toString();
        }
        return previousOut;
    }
